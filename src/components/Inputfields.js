...
<div className='supplierbutton'>
    ...
    <div id='inputcontainer1'>
        <div className='inputs'>
            ...
            <input className="box" type="text" name="text" id="text2" value={Price} placeholder='Price'  onChange={(e)=>setPrice(e.target.value)}/>
     ...
     <div id='inputcontainer2'>
        <div className='inputs'>
            ...
            <input className="box" type="text" name="text" id="text" value={Price} placeholder='Price'  onChange={(e)=>setPrice(e.target.value)}/>
